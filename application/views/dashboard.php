...
<head>
  ...
  <!-- css -->
  <?php $this->load->view('layout_penjual/css'); ?>
...
<body id="page-top">
  ...
  <!-- navbar -->
  <?php $this->load->view('layout_penjual/navbar'); ?>
        <!-- Begin Page Content -->
      ...
      <!-- Footer -->
      <?php $this->load->view('layout_penjual/footer'); ?>
      <!-- End of Footer -->
  ...
  <!-- js -->
  <?php $this->load->view('layout_penjual/js'); ?>
